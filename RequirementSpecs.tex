...
\section{Functional Requirements}
	...
	\subsection{Actor-System interaction modelling}
		\subsubsection {Save my location}
		\begin{tabular}{|p{7cm}|p{7cm}|}
			...
			\hline
			1. User clicks on Save my location & 2.  System asks the user to confirm if they want to save the location  \\
			\hline
			3  User clicks on confirm button. & 4. System saves current location under the user’s name in the database. \\
			\hline
			&  5. System displays that the location has been successfully saved\\
			\hline
		\end{tabular}
		\subsubsection {View saved location}
		\begin{tabular}{|p{7cm}|p{7cm}|}
			\hline
			\textbf{Actor: User} & \textbf{System: NavUP}\\
			\hline
			 & 0. Display user’s current location\\
			\hline
			1. The user clicks on view saved location & 2.   System displays a list of saved locations \\
			\hline
